...
class TemplateDataManager(VanillaDataManager):
    ...
    def __init__(
        ...
        **kwargs,  # pylint: disable=unused-argument
        ...
        if self.config.lidars_on_gpu is True and "lidar_image" in self.exclude_batch_keys_from_device:
            self.exclude_batch_keys_from_device.remove("lidar_image")
